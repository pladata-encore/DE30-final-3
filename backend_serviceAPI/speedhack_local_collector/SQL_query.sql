DROP DATABASE IF EXISTS `speed_hack`;
CREATE DATABASE IF NOT EXISTS `speed_hack`;
USE `speed_hack`;
...
CREATE TABLE `speed_hack_ap` (
    `match_id` VARCHAR(100),
    `account_name` VARCHAR(100),
    `account_id` VARCHAR(100),
    `vehicle_id` VARCHAR(100),
    `event_time_1` DATETIME(3),
    `event_time_2` DATETIME(3),
    `x1` DOUBLE,
    `x2` DOUBLE,
    `y1` DOUBLE,
    `y2` DOUBLE,
    ...
    `distance` DOUBLE,
    `time_diff` DOUBLE,
    `event_log` VARCHAR(100),
    `cm_per_s` DOUBLE,
    `km_per_h` DOUBLE,
    PRIMARY KEY (`match_id`,`account_id`,`account_name`,`event_time_1`,`event_time_2`,`event_log`,`cm_per_s`,`km_per_h`)
);
